...
public class homeworkLecture15 {
    WebDriver driver;
    WebDriverWait smallWait;
    WebDriverWait mediumWait;
    final String homepageUrl = "https://the-internet.herokuapp.com/";
    ...
    public void addRemoveElements() {
        driver.get(homepageUrl + "add_remove_elements/");
        System.out.println("Add Element");
        WebElement addElement = driver.findElement(By.xpath("//div/button"));
        addElement.click();

        System.out.println("Remove Element");
        WebElement removeElement = driver.findElement(By.cssSelector("button.added-manually"));
        removeElement.click();
    ...
    void dynamicControl() {
        ...
        mediumWait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.id("loading"))));
    ...
    void dynamicLoadedPageElement() {
        ...
        startBtn.click();
        mediumWait.until(ExpectedConditions.visibilityOfElementLocated(loadingBarLoc));
        mediumWait.until(ExpectedConditions.invisibilityOfElementLocated(loadingBarLoc));
    ...
    @Test
    void fileDownload() {
        String downloadFilepath = "C:\\Users\\Unknown\\Desktop";
